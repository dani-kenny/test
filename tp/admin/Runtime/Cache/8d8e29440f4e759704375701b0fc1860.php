...
<div class="content">
<div class="title"> 新增
<?php if(($level)  ==  "1"): ?>应用<?php endif; ?><?php if(($level)  ==  "2"): ?>模块<?php endif; ?><?php if(($level)  ==  "3"): ?>操作<?php endif; ?> [ <a href="__URL__">返回列表</a> ]</div>
<form method='post'  id="form1" >
<table cellpadding=3 cellspacing=3 >
<tr>
	<td class="tRight" ><?php if(($level)  ==  "1"): ?>应用<?php endif; ?><?php if(($level)  ==  "2"): ?>模块<?php endif; ?><?php if(($level)  ==  "3"): ?>操作<?php endif; ?>名：</td>
	<td class="tLeft" ><input type="text" class="medium bLeftRequire"  check='Require' warning="<?php if(($level)  ==  "1"): ?>应用<?php endif; ?><?php if(($level)  ==  "2"): ?>模块<?php endif; ?><?php if(($level)  ==  "3"): ?>操作<?php endif; ?>名称不能为空,且不能含有空格" name="name"></td>
</tr>
<tr>
