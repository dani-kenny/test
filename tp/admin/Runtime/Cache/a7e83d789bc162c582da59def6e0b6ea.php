...
<tr class="row" >
	<th class="tCenter space"><img SRC="__PUBLIC__/images/home.gif" WIDTH="16" HEIGHT="16" BORDER="0" ALT="" align="absmiddle"> <?php if(isset($_GET['title'])): ?>后台首页<?php endif; ?><?php if(!isset($_GET['title'])): ?>后台首页<?php endif; ?> </th>
</tr>
